# 让AI Agent不再"失忆"：我给my-agent加了两层上下文压缩
...
项目地址：https://github.com/spmno/my-agent

---

## 一、问题：Agent跑着跑着就"失忆"了

用过的朋友都知道，my-agent是一个自主循环的Agent——你给它一个目标，它自己规划、调工具、写代码、跑测试，中间不需要你管。
...
**1. 先调研再做，很重要。** 刚开始想自己拍脑袋想方案，后来花了一天看别人怎么做的，看完才知道每个方案的取舍在哪。Claude Code的五层压缩确实精细，但实现太复杂了，对my-agent这种个人项目来说，两层就够了。
...
https://github.com/spmno/my-agent
